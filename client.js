/**
 * </div>
 * https://github.com/DoniRandomChannel/botwa
 * Date: 14/09/20
 * client.js
**/
...
const EventHandler = async (client_, msg_) => {
    try {
        ...
        const krisarNumber = '62895604690202@c.us'  // pliese don't delete this variable.
        ...
        switch (args[0]) {
                ...
                case 'randomnime':
                    random_anim_hentai('anim').then(data => {
                        msg_.reply(new MessageMedia('image/jpeg', data.data, 'xspc-bot'))
                    })
                    break;
                case 'krisar':
